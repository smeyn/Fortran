...
c          #call writesp(spx, m, km1, in, kx1)
c          #call writesp(spy, m, km1, in, ky1)
          store = 0.
          i1 = jrot
          do 350 i=1,kx1
            hxi = spx(in,i)
...
c  there still can be added a knot.
 370    l = 0
        ...
        do 380 i=l1,l2
          ...
          fpmax = fpint(i)
 380    continue
c        call wrt_fpint(fpint, l1, l2, fpmax)
c  test whether we cannot further increase the number of knots.
        if(l.eq.0) go to 785
