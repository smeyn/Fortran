      def splev(t,n,c,k,x,y,m,ier):
    # c  def splev evaluates in a number of points x(i),i=1,2,...,m
    ...
    # c  are invalid control is immediately repassed to the calling def.
      ier = 10
      if(m-1) 100,30,10
  10  do 20 i=2,m
